...
import { RiFindReplaceLine, RiH1 } from "react-icons/ri";
...
const CollegeListing = () => {
  ...
  const fetchRoadmapListing = () => {
    axios
      .get("http://localhost:5000/admin/addcollege/getall")
      .then((result) => {
  ...
  return (
    <div className="relative w-full">
      <div className=" flex  flex-col md:min-w-[600px] overflow-x-hidden lg:max-w-[1535px] slider-container">
        ...
        <div className="absolute top-[150px] left-[300px] flex-col w-[60%] justify-center items-center">
          ...
          <div className="flex justify-center overflow-hidden mt-6 h-[55px] rounded-sm bg-white items-center">
            <RiH1 className="text-gray-400 w-[5%] pl-4">
              <RiFindReplaceLine />
            </RiH1>
            <input
              className="bg-transparent outline-none text-gray-400 w-[80%] h-[100%]"
              type="text"
              onChange={applysearch}
              placeholder="Search for colleges,courses,exams and more"
            />
            <button className="bg-orange-400 px-auto w-[15%] border-none h-[100%] text-white">
              Search
            </button>
          </div>
        </div>
      ...
      <div className=" md:flex-row md:ml-36 justify-start border overflow-x-scroll p-3 rounded-sm border-gray-400 slider-container w-[80%] ">
        <Slider {...settings}>
          <button onClick={(e) => filterByCategory("btech")}>
          ...
          <Link href="/">
            <div className=" h-[40px]   px-5 py-1   text-gray-500   w-[80px]">
              <h1 className="border-[2px]   border-l-green-400 border-r-blue-400 border-t-red-400 border-b-yellow-400 py-[3px] px-3 rounded-3xl w-[60px]">
                MBA
              </h1>
            </div>
          </Link>
          <Link href="/">
            <div className=" h-[40px]   px-5 py-1   text-gray-500   w-[80px]">
              <h1 className="border-[2px] py-1  border-l-green-400 border-r-blue-400 border-t-red-400 border-b-yellow-400 px-3 rounded-3xl w-[70px]">
                B.sc
              </h1>
            </div>
          </Link>
          ...
          {listing.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <td className="pr-4 py-2  max-w-[290px] min-w-[250px] text-lg   text-[#84c3d3] ">
                  <Link  href={"/mainpages/viewCollege/" + item._id}>
                    {" "}
                    {item.collegeName}{" "}
                ...
                <td className="px-4 py-2 max-w-[200px] text-gray-500 mt-3 md:text-md text-[17px] ">
                  {item.courses}
                </td>
                <td className="px-4 py-2 text-sm text-gray-500 max-w-[120px] ">
                  {item.collegeDetail}
                </td>
              </tr>
            );
