    ...
    <div className="relative ">
      <div className=" flex  flex-col md:min-w-[600px]  overflow-x-hidden lg:max-w-[1535px] slider-container  ">
        <Slider {...setting}>
          <div className="relative">
            <img
              className="lg:min-w-[1535px] md:min-w-[600px] md:h-[570px] min-h-[250px]"
            ...
            <div className="text-white hover:underline absolute w-20  bottom-1 lg:right-[300px] md:right-[250px] right-[100px]">
              <h1
                href={"/"}
                className="hover:text-yellow-500 text-lg  w-[350px]"
              >
                K.V.S Ayodhya{" "}
              </h1>
            </div>
          ...
          <div className=" relative">
            <img
              className="lg:min-w-[1535px] md:min-w-[600px] md:h-[570px] min-h-[250px]"
              src="https://media.istockphoto.com/id/156919428/photo/brandywine-heights-high-school-in-topton-pennsylvania.jpg?s=612x612&w=0&k=20&c=sQnVkYlvQQjBB_GIPrnqahzaiL6j1_JlzuCnFwPe4Y8="
              alt="image"
            />
            <div className="text-white hover:underline absolute w-20  bottom-1 lg:right-[300px] md:right-[250px] right-[100px]">
              <h1
                href={"/"}
                className="hover:text-yellow-500 text-md  w-[350px]"
              >
                Central Acadmy
              </h1>
            </div>
        ...
        <div className="absolute md:top-[27%] top-[3%] md:left-[25%] left-[20%] lg:left-[25%] flex-col w-[60%] ">
          <div className="flex justify-center items-center bg-transparent">
            <h1 className=" text-xl lg:hidden text-white font-semibold ">
          ...
          <div className="flex justify-between overflow-hidden lg:mt-10 lg:h-[55px] h-[40px] w-[110%] md:w-[90%] rounded-3xl  md:rounded-sm bg-white items-center">
            <h1 className="text-gray-400 w-[10%] md:pl-4 ">
              <RiFindReplaceLine />
            </h1>
            <input
              className="bg-transparent outline-none text-gray-400 w-[50%] overflow-x-hidden lg:w-[80%] h-[100%]"
              type="text"
              value={inputValue}
            ...
            <button
              onClick={applysearch}
              className="bg-orange-400  lg:w-[15%] w-[35%]  border-none h-[100%] text-white"
            >
              Search
            </button>
          </div>
      ...
      <div className=" md:mx-40 overflow-hidden  my-5">
        <div className="md:flex  mb-4 flex-wrap justify-start items-center">
          <div className="h-[270px] flex-col relative md:w-[380px]  w-[360px] rounded-md bg-gradient-to-b from-indigo-100 hover:shadow-indigo-300 shadow-md  hover:border-indigo-300  border-gray-300 border-2">
            <div className="flex">
              <div className="w-[250px]   h-[100px] ">
                <h1 className="ml-14 mt-9 text-ls md:text-xl hover:text-orange-500 font-semibold text-gray-700">
                  UP-Bord schools
                </h1>
            ...
            <div>
              <Link
                ...
                href={"/mainpages/upbordlisting"}
              >
                <p className="ml-16 mt-4 inline-block text-gray-500 hover:text-blue-600">
                  Top ranked Up-Bord Schools{" "}
                  <SlArrowRight className="inline-block hover:text-blue-600 text-gray-500  ml-1 text-[10px] font-extrabold" />
                </p>
              </Link>
            </div>
          </div>
          <div className="h-[270px] flex-col relative md:w-[380px] md:ml-4  w-[360px] rounded-md bg-gradient-to-b from-indigo-100 hover:shadow-indigo-300 shadow-md  hover:border-indigo-300  border-gray-300 border-2">
            <div className="flex">
              <div className="w-[250px]   h-[100px] ">
                <h1 className="ml-14 mt-9 text-lg md:text-xl hover:text-orange-500 font-semibold text-gray-700">
                  CBSC-Bord Schools
                </h1>
                <p className="ml-14 pt-4  text-gray-400 text-sm font-medium">
            ...
            <div>
              <Link
                className="absolute bottom-8 left-5"
                href={"/mainpages/cbsebordlisting"}
              >
                <p className="ml-16 mt-4 inline-block text-gray-500 hover:text-blue-600">
          ...
          <div className="h-[270px] flex-col relative md:w-[380px] md:ml-4 w-[360px] rounded-md bg-gradient-to-b from-indigo-100 hover:shadow-indigo-300 shadow-md  hover:border-indigo-300  border-gray-300 border-2">
            ...
            <Link
              className="absolute bottom-8 left-5"
              href={"/mainpages/icsebordlisting"}
            >
              <p className="ml-16 mt-4 inline-block hover:text-blue-600 text-gray-500">
                Top ranked ICSE-Bord Schools{" "}
                <SlArrowRight className="inline-block  hover:text-blue-600 text-gray-500  ml-1 text-[10px] font-bold" />
              </p>
            </Link>
          </div>
        </div>
