    ...
    <div className='font-sans relative'>
      <div className=' flex md:min-w-[1536px] flex-col md:w-[1536px] slider-container  '>
        <Slider {...setting}>
          ...
          <div className='  relative'>
            <img className='lg:min-w-[1536px] md:min-w-[600px] md:h-[510px] min-h-[250px]' src="https://image-static.collegedunia.com/public/asset/img/homepage/banner/Presidency1642652680.webp" alt="" />
          ...
          <div className=' relative'>
            <img className='lg:min-w-[1536px] md:min-w-[600px] md:h-[510px] min-h-[250px]' src="https://image-static.collegedunia.com/public/asset/img/homepage-new/banner/28.webp" alt="" />
            <div className='text-white hover:underline absolute w-20  bottom-1 right-[500px]'>
              <h1 href={"/"} className='hover:text-yellow-500 text-md  w-[450px]'>Shri Ram College of Commerce,New Delhi</h1>
            </div>
          </div>
          <div className=' relative'>
            <img className='lg:min-w-[1536px] md:min-w-[600px] md:h-[510px] min-h-[250px]' src="https://image-static.collegedunia.com/public/asset/img/homepage-new/banner/30.webp" alt="" />
            <div className='text-white hover:underline absolute w-20  bottom-1 right-[500px]'>
        ...
        <div className='absolute top-[150px] left-[300px] flex-col w-[60%] justify-center items-center'>
          <div className='flex justify-center items-center bg-transparent'>
            <h1 className='text-5xl text-gray-200 font-semibold '> Top BCA college in india</h1>
          </div>
      ...
      <div className='md:ml-40 md:w-[77%] my-5'>
        ...
        <div className='w-[80px] flex justify-start items-center ml-4'>
            ...
            <div className='w-[60px] flex mt-2 mr-3 '>
              <div className='flex justify-center overflow-hidden  items-center h-[50px] w-[50px] rounded-[50%] border '>
            <img className='h-[35px] w-[35px]  overflow-hidden ' src={item.image1} alt="" />
            </div>
            </div>
            <div className='w-[340px] flex-col justify-center items-center'>
              ...
              <p className='text-[16px] text-gray-600 font-normal'>{item.collegeAddress}</p>
            </div>
