...
const Ba = () => {
  ...
  const fetchRoadmapListing = () => {
    axios.get('http://localhost:5000/admin/bacollege/getall')
      .then((result) => {
    ...
    <div className='font-sans relative'>
      <div className=' flex md:min-w-[1536px] flex-col md:w-[1536px] slider-container  '>
        <Slider {...setting}>
          ...
          <div className=' relative'>
            <img className='lg:min-w-[1536px] md:min-w-[600px] md:h-[510px] min-h-[250px]' src="https://image-static.collegedunia.com/public/asset/img/homepage/banner/Presidency1642652667.webp" alt="" />
            <div className='text-white hover:underline absolute w-20  bottom-1 right-[500px]'>
        ...
        <div className='absolute top-[150px] left-[300px] flex-col w-[60%] justify-center items-center'>
          <div className='flex justify-center items-center bg-transparent'>
            <h1 className='text-5xl text-white font-semibold '> Top MCA college in india</h1>
          </div>
