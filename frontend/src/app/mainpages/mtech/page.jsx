      ...
      <div className=' flex md:min-w-[1536px] flex-col md:w-[1536px] slider-container  '>
        <Slider {...setting}>
          ...
          <div className='  relative'>
            <img className='lg:min-w-[1536px] md:min-w-[600px] md:h-[510px] min-h-[250px]' src="https://image-static.collegedunia.com/public/asset/img/homepage/banner/IIT1642251073.webp" alt="" />
          ...
          <div className=' relative'>
            <img className='lg:min-w-[1536px] md:min-w-[600px] md:h-[510px] min-h-[250px]' src="https://image-static.collegedunia.com/public/asset/img/homepage/banner/IIT1642251085.webp" alt="" />
            <div className='text-white hover:underline absolute w-20  bottom-1 right-[500px]'>
              <h1 href={"/"} className='hover:text-yellow-500 text-md  w-[450px]'>Shri Ram College of Commerce,New Delhi</h1>
            </div>
          </div>
          <div className=' relative'>
            <img className='lg:min-w-[1536px] md:min-w-[600px] md:h-[510px] min-h-[250px]' src="https://image-static.collegedunia.com/public/asset/img/homepage/banner/IIT1642251064.webp" alt="" />
            <div className='text-white hover:underline absolute w-20  bottom-1 right-[500px]'>
