...
const ViewBa = () => {
    ...
    const fetchProduct = async () => {
        const res = await fetch("http://localhost:5000/admin/bacollege/getbyid/" + id);
            ...
            <div className='w-full relative'>
                ...
                <div className={classess.div1}>
                    <div className='flex ml-[10%] mt-[5%]  text-white'>
                        <div className='flex'>
                            <img className='h-[50px] w-[50px]' src="" alt="logo" />
                        </div>
                        <div className='flex-col '>
                            <h1 className=' text-3xl uppercase font-semibold'>iit madras university</h1>
                            <div className='flex justify-start'>
                                <h1 className='text-md font-semibold'>madras</h1>
                                <h2 className='ml-4 text-md font-semibold'>dsfghjkl;</h2>
                                <h3 className='ml-4 text-md font-semibold'>qwertyuiop;lmnbvcsdfghjm</h3>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    {/* Icon Blocks */}
    <div className="max-w-[85rem] px-4 pt-5 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <h1 className='text-3xl font-semibold pb-5'>College Services</h1>
      {/* Grid */}
