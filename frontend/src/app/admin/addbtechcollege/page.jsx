...
const AddCollege = () => {
  ...
  onSubmit: (values, { resetForm }) => {
    ...
    axios.post('http://localhost:5000/admin/addbtechcollege/add', values)
      .then((response) => {
        ...
        <form onSubmit={addcollege.handleSubmit} className='ml-5'>
          ...
          <div>
            ...
            <input
              ...
              className='w-[80%] border-dotted border-b-2 outline-none  border-b-gray-600 mb-4'
            />
          </div>
          <div>
            <label className='pr-5 font-semibold text-xl' htmlFor="ranking">ApplicationDeadline :</label>
            <input
              type="text"
          ...
          <div>
            <label className='pr-5 font-semibold text-xl' htmlFor="cutoff">cut Off :</label>
            <input
              type="text"
              id='cutoff'
              name='cutoff'
          ...
          <div>
            <label className='pr-5 font-semibold text-xl' htmlFor="image2">Image :</label>
            <input
              type="text"
              id='image2'
              name='image2'
