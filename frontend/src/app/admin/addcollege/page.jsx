        ...
        <div className='flex justify-center m-5 items-center '>
            <div className='w-[50%] flex-col   border-2 rounded-lg'>
                ...
                <form onSubmit={addcollege.handleSubmit} className='ml-5'>
                    <div>
                        <label className='pr-2 font-semibold text-xl' htmlFor='collegeName'>UniversityName:</label>
                        <input
                            type="text"
                            name="collegeName"
                            id='collegeName'
                            onChange={addcollege.handleChange}
                            value={addcollege.values.collegeName}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name='collegeAddress'
                            onChange={addcollege.handleChange}
                            value={addcollege.values.collegeAddress}
                    ...
                    <div>
                        ...
                        {/* add university link */}
                        <div>
                        <label className='pr-5 font-semibold text-xl' htmlFor="linkCollege">linkCollege:</label>
                        <input
                            type="text"
                            id='linkCollege'
                            name='linkCollege'
                            onChange={addcollege.handleChange}
                            value={addcollege.values.linkCollege}
