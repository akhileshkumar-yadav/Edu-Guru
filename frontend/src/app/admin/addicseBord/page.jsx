...
const AddIcseBord= () => {
    const addcollege = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            ...
            axios.post('http://localhost:5000/admin/addicseBord/add', values)
                .then((response) => {
    ...
    return (
        <div className='flex justify-center m-5 items-center '>
            <div className='w-[50%] flex-col   border-2 rounded-lg'>
                <h1 className='text-3xl font-semibold text-center mb-4 mt-3 '>Add School</h1>
