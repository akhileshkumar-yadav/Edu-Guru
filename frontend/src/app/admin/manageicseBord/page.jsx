...
const ManageUser = () => {
    ...
    const deleteUser = (id) => {
        axios.delete(`http://localhost:5000/admin/addicseBord/delete/` + id)
            .then((result) => {
                            ...
                            userList.map((user) => {
                                ...
                                <td onClick={() => deleteUser(user._id)}  className='p-2 border border-violet-700'
                                    ...
                                    <td  className='p-2 border border-violet-700'>
                                        <Link href={'/admin/updateICSEbord/' + user._id} className='bg-yellow-500 text-white px-4 py-2 rounded-lg'>
                                            Update
                                        </Link>
                                    </td>
                                </tr>
