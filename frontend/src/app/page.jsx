    ...
    <div>
      ...
      <div className="font-sans relative">
        <div className=" flex flex-col md:min-w-[600px] overflow-x-hidden lg:max-w-[1536px] slider-container ">
          <Slider {...setting}>
            <div className="  relative ">
              <img
                className="lg:min-w-[1536px]  md:min-w-[600px] md:h-[510px] min-h-[250px]"
            ...
            <div className=" relative">
              <img
                className="lg:min-w-[1536px] md:min-w-[600px] md:h-[510px] min-h-[250px]"
                src="https://ir.iith.ac.in/assets/images/home/Jaykishan%20Pipaliya.jpeg"
                alt="shri"
              />
          ...
          <div className="absolute  md:top-[7%] top-[2%] md:left-[25%] left-[20%] lg:left-[25%] flex-col w-[60%]  ">
            <div className="flex justify-center items-center bg-transparent">
              <h1 className=" text-lg lg:hidden  text-white font-semibold ">
                Find Top University in india
              </h1>
            ...
            <div className="flex justify-between overflow-hidden mt-4 lg:mt-10 lg:h-[55px] h-[40px] w-[90%]  rounded-3xl  md:rounded-sm bg-white items-center">
              <h1 className="text-gray-400 hidden md:block w-[5%] pl-4">
                <RiFindReplaceLine />
              </h1>
              <input
                className="bg-transparent outline-none pl-3 text-gray-400 w-[50%] lg:w-[80%] h-[100%]"
                type="text"
                value={inputValue}
              ...
              <button
                onClick={applysearch}
                className="bg-orange-400 px-2 lg:w-[15%] w-[30%]  border-none h-[100%] text-white"
              >
                Search
              </button>
            </div>
        ...
        <div className=" md:mx-40 overflow-hidden  my-5">
          <h1 className="text-3xl mb-4 text-gray-900 font-semibold ">
            Explore Programs
          </h1>

          <div className="flex lg:flex-row lg:gap-0 gap-4 flex-col mb-4 flex-wrap justify-start items-center">
            <div className="h-[270px] flex-col relative md:w-[380px] w-[360px] rounded-md bg-gradient-to-b from-indigo-100 hover:shadow-indigo-300 shadow-md  hover:border-indigo-300  border-gray-300 border-2">
              <div className="flex">
                <div className="w-[250px] h-[100px] ">
                  <h1 className="ml-14 mt-9 text-xl md:text-3xl hover:text-orange-500 font-semibold text-gray-700">
                    Top University
                  </h1>
                  <p className="ml-14 pt-4  text-gray-400 text-sm font-medium">
                    College ranked based on real data
                  </p>
                </div>
                <div className="h-[100px]">
                  <img
                    className="md:h-[100px]  md:w-[100px] mt-9 h-[50px] w-[50px] "
                    src="\—Pngtree—illustration of graduate college student_6293725.png"
                    alt="image"
                  />
                </div>
              </div>
              ...
              >
                <p className="ml-16 mt-4 inline-block text-gray-500">
                  Top ranked college in india{" "}
                  <SlArrowRight className="inline-block text-gray-500  ml-1 text-[8px] font-extrabold" />
                </p>
              </Link>
            </div>
            <div className="h-[270px] flex-col relative md:w-[380px] md:ml-4  w-[360px] rounded-md bg-gradient-to-b from-indigo-100 hover:shadow-indigo-300 shadow-md  hover:border-indigo-300  border-gray-300 border-2">
              <div className="flex">
                ...
                <div className="h-[100px]">
                  <img
                    className="md:h-[100px]  md:w-[100px] mt-9 h-[50px] w-[50px] "
                    src="10088-removebg-preview.png"
                    alt="image"
                  />
                </div>
              </div>
            ...
            <div className="h-[270px] flex-col relative md:w-[380px] md:ml-4  w-[360px] rounded-md bg-gradient-to-b from-indigo-100 hover:shadow-indigo-300 shadow-md  hover:border-indigo-300  border-gray-300 border-2">
              <div className="flex">
                <div className="w-[250px]   h-[100px] ">
                  ...
                  <p className="ml-14 pt-4  text-gray-400 text-sm font-medium">
                    School ranked based on real data
                  </p>
                </div>
                <div className="h-[100px]">
                  <img
                    className="md:h-[100px]  md:w-[100px] mt-9 h-[50px] w-[50px] "
                    src="Na_Nov_28-removebg-preview.png"
                    alt="image"
                  />
                </div>
              </div>
        ...
        <div className="md:w-[80%] ml-3 mr-3 border p-3 md:ml-36  rounded-sm border-gray-400 overflow-x-auto mb-3">
          <div className=" flex-row  justify-start  min-w-[1068px]   ">
            <Slider className="" {...settings}>
              ...
              >
                <div className=" h-[40px]   px-5 py-1   text-gray-500   w-[90px]">
              ...
              <button
                onClick={(e) => filterByCategory("Mtech")}
                className="overflow-x"
                href="/"
              >
                <div className=" h-[40px]   px-5 py-1   text-gray-500   w-[90px]">
              ...
              <button
                onClick={(e) => filterByCategory("BBA")}
                className=""
                href="/"
              >
                <div className=" h-[40px] px-5 py-1   text-gray-500  w-[80px]">
              ...
              <button onClick={(e) => filterByCategory("MBA")} href="/">
                <div className=" h-[40px]   px-5 py-1   text-gray-500   w-[80px]">
              ...
              <button onClick={(e) => filterByCategory("BCA")} href="/">
                <div className=" h-[40px]   px-5 py-1   text-gray-500   w-[80px]">
                  <h1 className="border-[2px] py-1  border-l-green-400 border-r-blue-400 border-t-red-400 border-b-yellow-400 px-3 rounded-3xl w-[60px]">
                    BCA{" "}
                  </h1>
              ...
              <button onClick={(e) => filterByCategory("B.Com")} href="/">
                <div className=" h-[40px]   px-5 py-1   text-gray-500 w-[80px]">
                ...
                if (index <= 5) {
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-gray-500  max-w-[120px] ">
          ...
          <div className="grid gap-12 ">
            <div>
              ...
              <p className="mt-3   text-lg text-gray-700 0">
                The vision of "TopFiveEduGuru" is to empower students and
                parents by providing accurate, unbiased, and transparent
                information about colleges. The platform aims to simplify the
                decision-making process through data-driven insights and
                user-friendly tools, ensuring that users can make well-informed
                choices. By promoting transparency through authentic reviews and
                feedback, the project aspires to bridge the gap between students
            ...
            <div className="space-y-6 lg:space-y-10">
              ...
              <div className="flex gap-x-5 sm:gap-x-8">
                ...
                <div className="grow">
                  ...
                  <p className="mt-1 text-gray-700 hover:text-blue-300 ">
                    Making the journey of choosing the right college easy,
                    efficient, and stress-free through innovative tools.
                  </p>
                </div>
              </div>
              {/* End Icon Block */}
              ...
              <div className="flex gap-x-5 sm:gap-x-8">
                ...
                <div className="grow ">
                  ...
                  <p className="mt-1 text-gray-700 hover:text-blue-300 ">
                    Providing accurate insights and unbiased information to
                    enable informed and confident decisions.
                  </p>
                </div>
              </div>
              {/* End Icon Block */}
              ...
              <div className="flex gap-x-5 sm:gap-x-8">
                ...
                <div className="grow">
                  ...
                  <p className="mt-1 text-gray-700 hover:text-blue-300 ">
                    Creating opportunities for students to align their education
                    with their aspirations, fostering growth and success.
                  </p>
                </div>
              </div>
              {/* End Icon Block */}
