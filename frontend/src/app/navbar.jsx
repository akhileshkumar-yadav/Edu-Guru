      ...
      <header className="shadow-md bg-white font-[sans-serif] tracking-wide relative z-50">
        ...
        <div className="flex flex-wrap justify-center px-10 py-3 relative">
          ...
          >
            ...
            <ul className="absolute top-5 max-lg:top-8 left-0 z-50 block space-y-2 shadow-lg bg-white max-h-0 overflow-hidden min-w-[450px] group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500">
